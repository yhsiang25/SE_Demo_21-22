...
public class Client {
	...
	public static void main(String[] args) {
		...
		double total = calculateCost (namesList);
		System.out.println("Total Cost = " + total);

	}
	
	private static double calculateCost(List<HouseholdItem> householdItmes) {
		HouseholdItemVisitor visitor = new HouseholdItemVisitorImpl ();
		double sum = 0.0;
		for (HouseholdItem i : householdItmes) {
			 i.accept(visitor);
		}
		return sum;
	}
